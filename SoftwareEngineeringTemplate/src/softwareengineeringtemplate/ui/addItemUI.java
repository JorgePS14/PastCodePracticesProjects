...
import softwareengineeringtemplate.Bottoms;
import softwareengineeringtemplate.Clothes;
import softwareengineeringtemplate.Shoes;
import softwareengineeringtemplate.Tops;
...
public class addItemUI extends javax.swing.JFrame {
    ...
    public addItemUI(SwEnUI parent, boolean modal) {
        initComponents();
        this.parent = parent;
    }
