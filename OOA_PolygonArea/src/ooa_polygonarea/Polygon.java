    ...
    public double area() {
        ...
        for(int i = 0; i < this.numVertices; i++) {
            if(i == this.numVertices-1) {
                tempArea += (this.vertices[i].getX()*this.vertices[0].getY()
                        -this.vertices[i].getY()*this.vertices[0].getX())/2;
            } else {
                tempArea += (this.vertices[i].getX()*this.vertices[i+1].getY()
                        -this.vertices[i].getY()*this.vertices[i+1].getX())/2;
            }
        }
